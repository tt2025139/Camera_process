...
class CONFIG:
    ...
    LOWER_COLOR_BOUND_1 = np.array(
        [55, 20, 50]
    )  # Example: Brown for a box 示例 (红色低位): np.array([0, 100, 100])
    UPPER_COLOR_BOUND_1 = np.array(
        [75, 160, 180]
    )  # Example: Brown for a box 示例 (红色低位): np.array([20, 255, 255])
                ...
                if a != -1 and b != -1:
                    ...
                    if jpg:
                        ...
                        if CONFIG.CALCULATE_HSV_INFO:
                            ...
                            print(
                                f"HSV Sums: H={hsv_sum[0]}, S={hsv_sum[1]}, V={hsv_sum[2]}"
                            )
